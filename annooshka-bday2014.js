...
(function() {
  var Background, Ball, Block, Game, Platform, blocks_map, init, resize_blocks,
  ...
  Game = (function() {
    ...
    Game.prototype.iteration = function() {
      var _this = this;
      this.platform.make_action(this.ctx);
  ...
  init = function() {
    ...
    g = new Game(ctx, static_objects, new Platform(w / 2, 2 * h, h * 0.02, h * 1.025, 1.45 * Math.PI, 1.55 * Math.PI, w * 0.03), new Ball(w / 2, h * 0.8, 1, -1, radius), w, h);
